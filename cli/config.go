...
var configCmd = &cobra.Command{
	Use:   "config",
	Short: "Setup config file for graphenesnakeos-stack",
	Run: func(cmd *cobra.Command, args []string) {
		...
		defaultName := fmt.Sprintf("graphenesnakeos-%v-%v", result, randomString(10))
		...
		defaultKeypairName := "graphenesnakeos"
		...
		log.Infof("graphenesnakeos-stack config file has been written to %v", configFileFullPath)
	},
}
